![docker image](https://github.com/fliaght/novel_mof_oasis/actions/workflows/docker-publish.yml/badge.svg)


# fliaght's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of fliaght.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/fliaght/novel_mof_oasis.git
    cd novel_mof_oasis
    ```
    ...
    ```sh
    curl-L -o novel_mof_oasis.zip "https://github.com/fliaght/novel_mof_oasis/archive/main.zip"
    unzip novel_mof_oasis.zip
    cd novel_mof_oasis
    ```
...
your `docker-compose.yaml` with `ghcr.io/fliaght/novel_mof_oasis:main` for the services
...
```sh
docker pull ghcr.io/fliaght/novel_mof_oasis/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/fliaght/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/fliaght/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/fliaght/novel_mof_oasis/manifests/main": unauthorized`
